...
// Shortcode to display Instagram posts from the database
function itwp_display_instagram_posts( $atts ) {
    ...
    foreach ( $posts as $post ) {
        ...
        $html .= '<h2>' . esc_html( get_the_title( $post->ID ) ) . '</h2>';
...
add_shortcode( 'instagram_basic_display_api', 'itwp_display_instagram_posts' );
